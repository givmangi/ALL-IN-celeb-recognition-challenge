...
This is my first attempt at using DINOv2 (Vision Transformer, ViT-L/14)
...
Approach:
- Extract 1024-dimensional embeddings from DINOv2 for all query and gallery images
...
# Batching function
def batching(images, batch_size=16):
    features = []
...
gallery_features = batching(gallery_images, batch_size=16)
